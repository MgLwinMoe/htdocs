    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                ...
                <x-admin-link :href="route('admin.permission.index')"
                    :active="request()->routeIs('admin.permission.index')">Permissions</x-admin-link>
                {{-- <x-admin-link :href="route('admin.users.index')" :active="request()->routeIs('admin.user.index')">Users --}}
                {{-- </x-admin-link> --}}
